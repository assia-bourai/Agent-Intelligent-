...
public class ProductBuyerAgent extends Agent {
	...
	protected void setup() {
		...
		// passer le produit à acheter comme argument
		...
		if (args != null && args.length > 0) {
			...
			System.out.println("le nom du produit n'a pas été spécifié");
			doDelete();
		}
	}
	...
	/**
	 * Classe interne RequestPerformer. comportement utilisé par l'agent acheteur
	 * pour répondre à l'agent vendeur
	 */
	private class RequestPerformer extends Behaviour {
		...
		public void action() {
			...
			case 0:
				...
				break;
			case 1:
				// Reception des réponses des agents vendeurs
				...
				break;
			case 2:
				// envoie du bon de commande  à l'agent vendeur 
			...
			case 3:
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						...
						System.out.println(targetProductName + " acheté avec succès "
								+ reply.getSender().getName());
						System.out.println("Price = " + Price);
						myAgent.doDelete();
					} else {
						System.out.println("Echec de l'achat du produit, réessayez.");
					}
